...
/*
fn generate_crate_file(pkg: &bazel::Package) {
...
pub fn generate_override_file(should_overwrite: bool) -> Result<(), Box<CargoError>> {
    let file_contents = format!(
r#""""
...
pub fn generate_workspace_file(workspace: &bazel::Workspace) -> Result<(), Box<CargoError>> {
    let file_contents = format!(
r#""""
